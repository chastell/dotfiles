...
map <leader>fg  ggCFrom: Piotr Szotkowski <chastell@gmail.com><esc>G?^— .<enter>C— Piotr Szotkowski<esc>
map <leader>fh  ggCFrom: Piotr Szotkowski <shot@hot.pl><esc>G?^— .<enter>C— Piotr Szotkowski<esc>
