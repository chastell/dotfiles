...
alias backup-mobile='rsync --archive --delete --delete-excluded --exclude=.thumbnails --exclude=cache --exclude=com.babbel.mobile.android.en --exclude=com.ea.game.starwarscapital_row --exclude=com.netflix.mediaclient --exclude=com.spotify.music --exclude=podcasts --partial --progress --rsh="ssh -p 2222" admin@192.168.2.150:SDCard/ /luggage/XZ1 && rsync --archive --delete --delete-excluded --exclude=.thumbnails --exclude=cache --exclude=com.babbel.mobile.android.en --exclude=com.netflix.mediaclient --exclude=com.spotify.music --exclude=podcasts --partial --progress --rsh="ssh -p 2222" admin@192.168.2.150:/storage/ /luggage/XZ1.storage'
...
alias rr='rerun --clear --exit -- rake'
...
alias vh='vs | head'
alias vs='ls *.{avi,flv,mkv,mov,mp4,ogv,webm} 2>/dev/null | while read; do echo $(mediainfo --Inform="General;%Duration/String3%" "$REPLY") $REPLY; done | sort'
