...
alias backup='offlineimap; reset; rm -r ~/.cache ~/.local/share/Trash ~/.thumbnails; beep; rdiff-backup --print-statistics -v5 /home/chastell /media/Deep\ Thought/X301.rdiff; beep -r 3'
