...
alias backup-to-fenchurch='offlineimap && sudo rdiff-backup --exclude /home/chastell/.cache --exclude /tmp --exclude-other-filesystems --exclude-special-files --print-statistics --verbosity 5 / /media/fenchurch/devielle'
