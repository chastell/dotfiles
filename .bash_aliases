...
alias serve='ruby -run -e httpd -- -p 8080 . & xdg-open http://localhost:8080'
alias sig='signore'
...
alias vs='ls | egrep -iv jpe?g$ | while read; do echo $(ffprobe "$REPLY" 2>&1 | grep -o "Duration: [0-9:]\+") $REPLY; done | grep ^Duration: | sort'
