...
alias backup-nexus='rsync --archive --delete --delete-excluded --exclude=cache --exclude=com.netflix.mediaclient --exclude=podcasts --partial --progress --rsh="ssh -p 2222" admin@192.168.2.27:/storage/emulated/0/ /luggage/Nexus'
