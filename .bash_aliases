...
alias backup-to-fenchurch-luggage='fen && sudo rsync --delete --exclude=/luggage/2del --exclude=/luggage/Gmail --exclude=/luggage/Steam/steamapps/common --links --no-inc-recursive --partial --progress --recursive --times /luggage /fenchurch/desaxe.luggage; unfen'
