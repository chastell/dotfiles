...
alias backup-to-fenchurch-luggage='fen && sudo rsync --delete-before --links --no-inc-recursive --partial --progress --recursive --times /luggage /fenchurch/desaxe.luggage && unfen'
...
alias rc='rerun --background --clear --exit --pattern "**/*.{cr,yml}" -- crystal spec --define=mt_no_expectations'
